...
require 'wsse_signer/digester'
require 'wsse_signer/version'
...
module WsseSigner
  class Signer
    ...
    def signature_digest_algorithm=(algorithm)
      @sign_digester = Digester.new(algorithm)
    ...
    def binary_security_token_node
      ...
      puts "GENERATE SECURY TOKEN NODE"
    ...
    def digest!(target_node, options = {})
      ...
      reference_node['URI'] = !id.to_s.empty? ? "##{id}" : ''
